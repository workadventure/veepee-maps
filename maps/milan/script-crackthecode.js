    ...
    popupCrackTheCode: {
        ...
        buttons: [
            ...
            },
            {
                ...
                className: "popUpElement",
                callback: (popupValue) => {
                    WA.openCoWebSite('https://backup-workadventure-db-prod.s3-eu-west-1.amazonaws.com/map/VEEPEE_V6/CrackTheCode/RIDDLE-8-GUESS-THE-PLACE-IN-ITALY-MILAN-FOOTBALL-BALLOON-ITEM.pdf');
                    popupValue.close();
                }
            },
        ]
