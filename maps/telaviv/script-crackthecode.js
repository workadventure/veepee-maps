    ...
    popupCrackTheCode: {
        ...
        buttons: [
            ...
            },
            {
                ...
                className: "popUpElement",
                callback: (popupValue) => {
                    WA.openCoWebSite('https://backup-workadventure-db-prod.s3-eu-west-1.amazonaws.com/map/VEEPEE_V6/CrackTheCode/RIDDLE-6-CRACK-THE-4-DIGITS-IN-ISRAEL-CRACK-THE-4-DIGIT-IN-ISRAEL-TEL-AVIV-SKETEBOARD-ITEM.pdf');
                    popupValue.close();
                }
            },
        ]
